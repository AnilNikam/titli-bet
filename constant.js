const CONST = {
  ...
  // Socket events names
    ...
    // Anadar Bahar  ============================================
    ANADAR_BAHAR_PLAYGAME: 'ABPG',
    ANADAR_BAHAR_JOIN_TABLE: "ABJT",
    ANADAR_BAHAR_ROUND_START_TIMER: 'ANADAR_BAHAR_GameStartTimer',
    ANADAR_BAHAR_GAME_TABLE_INFO: 'ABGTI',
    STARTANADAR_BAHAR_: "START_ANADAR_BAHAR",
    ANADAR_BAHAR_LOGIC: "Client",
    ACTION_ANADAR_BAHAR: "ACTION_ANADAR_BAHAR",
    ANADAR_BAHAR_GAME_START_TIMER: 'ABGST',
    ANADAR_BAHAR_WINNER: "ANADAR_BAHAR_WINNER",
    LEAVETABLEANADAR_BAHAR:"LEAVETABLEANADAR_BAHAR",
    ClearBetANADAR_BAHAR: "ClearBetANADAR_BAHAR",
    CHECKOUT_ANADAR_BAHAR:"CHECKOUT_ANADAR_BAHAR",

  // SORAT ============================================
  SORAT_PLAYGAME: 'SPG',
  SORAT_JOIN_TABLE: "SOJT",
  SORAT_ROUND_START_TIMER: 'SoratGameStartTimer',
  SORAT_GAME_TABLE_INFO: 'SGTI',
  STARTSORAT: "STARTSORAT",
  SORATLOGIC: "Client",
  ACTIONSORAT: "ACTIONSORAT",
  SORAT_GAME_START_TIMER: 'SGST',
